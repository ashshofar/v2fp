...
@section('content')
			...
			<div class="mdl-grid site-max-width">
              <div class="mdl-cell mdl-cell--12-col mdl-card welcome-card mdl-shadow--4dp portfolio-card">
                <div class="mdl-card__title">
                  <h2 class="mdl-card__title-text">Indonesia Family Planning 2020</h2>
                </div>
                <div class="mdl-card__actions mdl-card--border">
                  <div class="mdl-card__supporting-text">
                    <h5><center>{{ $intro->narrative }}</center></h5>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div id="working">
                  <section class="section--center mdl-grid site-max-width">
                    <div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                        ...
                        <div class="mdl-card__title">
                            <h2 class="mdl-card__title-text">FP Strategy &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h2>
                        </div>
                        <div class="mdl-card__supporting-text">
                            {{ $strategyshort }}
                ...
                <div id="our">
                  <section class="section--center mdl-grid site-max-width">
                    ...
                    <div class="mdl-cell mdl-cell--6-col mdl-card mdl-shadow--4dp portfolio-card">
                        ...
                        <div class="mdl-card__title">
                            <h2 class="mdl-card__title-text">FP2020 CC Members</h2>
                        </div>
                        <div class="mdl-card__supporting-text">
          ...
          <section class="section--center mdl-grid site-max-width">
            <div class="mdl-card mdl-cell mdl-cell--12-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone  mdl-shadow--4dp">
              <div class="mdl-card__title">
                  <h2 class="mdl-card__title-text">Key Document</h2>
              </div>
              <div class="mdl-card__actions  mdl-card--border">
                  <section class="section--center mdl-grid site-max-width">
                    ...
                    <div class="mdl-cell mdl-cell--6-col portfolio-card">
                        <div class="mdl-card__title">
                            <h2 class="mdl-card__title-text">FP2020 CC Documents</h2>
                        </div>
                        <div class="mdl-card__supporting-text">
                          <ul>
                            ...
                            <li><a href="{{ route('frontend.document') }}" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect mdl-button--accent">Powerpoints</a></li>
                            <li><a href="{{ route('frontend.document') }}" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect mdl-button--accent">TORs and MOM</a></li>
                          </ul> 
                        </div>
                    </div>
                  </section>
          ...
          <div class="homepage-footer">
            <section class="mdl-grid site-max-width">
                <div class="mdl-cell mdl-card mdl-cell--8-col mdl-cell--4-col-tablet  mdl-shadow--4dp portfolio-card">
                  <div class="mdl-card__title">
                      <h2 class="mdl-card__title-text">News and Updates</h2>
                  </div>
